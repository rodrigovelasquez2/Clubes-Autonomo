...
let cards = [
    {
        id: "card1",
        background: "../contenido/img/juego1.jpg",
        display_background: "../contenido/img/juego1.jpg",
        title: "BTS Island: In the Seom",
        description:
            "Juego de rompecabezas con los siete miembros del grupo como protagonistas.",
        category: "GAMER"
    },
    {
        id: "card2",
        background: "../contenido/img/juego2.jpg",
        display_background: "../contenido/img/juego2.jpg",
        title: "Mortal Kombat",
        description:
            "La travesía de Liu Kang para salvar al mundo del malvado hechicero Shang Tsung, travesía que acaba con su enfrentamiento en el torneo llamado Mortal Kombat",
        category: "GAMER"
    },
    {
        id: "card3",
        background: "../contenido/img/juego3.jpg",
        display_background: "../contenido/img/juego3.jpg",
        title: "Resident Evil",
        description:
            "Sigue a Chris Redfield y Jill Valentine, miembros de una fuerza de élite conocida como S.T.A.R.S., mientras investigan las afueras de Raccoon City tras la desaparición de los miembros de su equipo",
        category: "GAMER"
    },
    {
        id: "card4",
        background: "../contenido/img/juego4.jpg",
        display_background: "../contenido/img/juego4.jpg",
        title: "Overwatch",
        description:
            "Juego de acción en equipo gratuito ambientado en un futuro optimista en el que todas las partidas presentan una refriega definitiva 5c5.",
        category: "GAMER"
    },
    {
        id: "card5",
        background: "../contenido/img/juego5.jpg",
        display_background: "../contenido/img/juego5.jpg",
        title: "Super Mario Odyssey",
        description:
            "Únete a Mario y su compañero Cappy en esta monumental aventura en 3D al mejor estilo trotamundos con Super Mario Odyssey para Nintendo Switch.",
        category: "GAMER"
    },
    {
        id: "card6",
        background: "../contenido/img/juego6.jpg",
        display_background: "../contenido/img/juego6.jpg",
        title: "Splatoon",
        description:
            "Serie de videojuegos de disparos en tercera persona de Nintendo.",
        category: "GAMER"
    },
    {
        id: "card7",
        background: "../contenido/img/anime1.jpg",
        display_background: "../contenido/img/anime1.jpg",
        title: "Bungou Stray dogs #1",
        description: "TOP: Muertes de bungou Stray dogs",
        category: "ANIME"
    },
    {
        id: "card8",
        background: "../contenido/img/anime2.jpg",
        display_background: "../contenido/img/anime2.jpg",
        title: "Bungou Stray dogs #2",
        description: "¿Quién es chuya Nakamahara?",
        category: "ANIME"
    },
    {
        id: "card9",
        background: "../contenido/img/anime3.jpg",
        display_background: "../contenido/img/anime3.jpg",
        title: "Netflix anime",
        description: "Top los mejores animes en Netflix",
        category: "ANIME"
    },
    {
        id: "card10",
        background: "../contenido/img/anime4.jpg",
        display_background: "../contenido/img/anime4.jpg",
        title: "Dibujar Anime #1",
        description: "Aprende a dibujar anime siguiendo estos consejos.",
        category: "ANIME"
    },
    {
        id: "card11",
        background: "../contenido/img/anime5.jpg",
        display_background: "../contenido/img/anime5.jpg",
        title: "Dibujar Anime #2",
        description: "Aprende a dibujar rostro de anime siguiendo estos consejos.",
        category: "ANIME"
    },
    {
        id: "card12",
        background: "../contenido/img/anime6.jpg",
        display_background: "../contenido/img/anime6.jpg",
        title: "Dibujar Anime #3",
        description: "Aprende a dibujar anime siguiendo estos consejos.",
        category: "ANIME"
    },
    {
        id: "card13",
        background: "../contenido/img/pet1.jpg",
        display_background: "../contenido/img/pet1.jpg",
        title: "Especial mascota #1",
        description: "Dia especial de las mascotas",
        category: "PET"
    },
    {
        id: "card14",
        background: "../contenido/img/pet2.jpg",
        display_background: "../contenido/img/pet2.jpg",
        title: "Cuidados de tu mascota #1",
        description: "Ten en cuenta los siguientes pasos",
        category: "PET"
    },
    {
        id: "card15",
        background: "../contenido/img/pet3.jpg",
        display_background: "../contenido/img/pet3.jpg",
        title: "Cuidados de tu mascota #2",
        description: "Ten en cuenta los siguientes pasos",
        category: "PET"
    },
    {
        id: "card16",
        background: "../contenido/img/pet4.jpg",
        display_background: "../contenido/img/pet4.jpg",
        title: "Cuidados de tu mascota #3",
        description: "Ten en cuenta los siguientes pasos",
        category: "PET"
    },
    {
        id: "card17",
        background: "../contenido/img/pet5.jpg",
        display_background: "../contenido/img/pet5.jpg",
        title: "Cuidados de tu mascota #4",
        description: "Ten en cuenta los siguientes pasos",
        category: "PET"
    },
    {
        id: "card18",
        background: "../contenido/img/pet6.jpg",
        display_background: "../contenido/img/pet6.jpg",
        title: "Cuidados de tu mascota #5",
        description: "Ten en cuenta los siguientes pasos",
        category: "PET"
    },
    {
        id: "card19",
        background: "../contenido/img/libro1.jpg",
        display_background: "../contenido/img/libro1.jpg",
        title: "TOP LIBROS #1",
        description: "Conocelos",
        category: "LIBRO"
    },
    {
        id: "card20",
        background: "../contenido/img/libro2.jpg",
        display_background: "../contenido/img/libro2.jpg",
        title: "TOP LIBROS #2",
        description: "Conocelos",
        category: "LIBRO"
    },
    {
        id: "card21",
        background: "../contenido/img/libro3.jpg",
        display_background: "../contenido/img/libro3.jpg",
        title: "TOP LIBROS #3",
        description: "Conocelos",
        category: "LIBRO"
    },
    {
        id: "card22",
        background: "../contenido/img/libro4.jpg",
        display_background: "../contenido/img/libro4.jpg",
        title: "TOP LIBROS #4",
        description: "Conocelos",
        category: "LIBRO"
    },
...
const AddCards = () => {
  ...
  <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
            ...
            button_container.append(button1, button3, button4);
...
// Obtener todas las áreas de contenido
const contentAreas = document.querySelectorAll(".content-area");

// Iterar a través de las áreas de contenido y obtener la categoría
contentAreas.forEach((area) => {
    const categoria = area.getAttribute("data-categoria");
    console.log(`Categoría: ${categoria}`);
    // Puedes usar la variable "categoria" como desees en tu código JavaScript
});
